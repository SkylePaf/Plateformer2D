...
const VINES_DATAS: Dictionary = {
	"SMALL": {
		...
		"REGULAR_ICED": {
			"REGIONS_RECTS": [
				Rect2(0.0, 1.0, 16.0, 32.0), Rect2(16.0, 1.0, 16.0, 32.0),
				Rect2(32.0, 1.0, 16.0, 32.0), Rect2(48.0, 1.0, 16.0, 32.0),
				Rect2(64.0, 1.0, 16.0, 32.0), Rect2(80.0, 1.0, 16.0, 32.0),
				Rect2(96.0, 1.0, 16.0, 32.0), Rect2(112.0, 1.0, 16.0, 32.0)
			],
			"COLOR": Color(0.545, 0.713, 0.466)
		},
		"BLUE_ICED": {
			"REGIONS_RECTS": [
				Rect2(0.0, 113.0, 16.0, 32.0), Rect2(16.0, 113.0, 16.0, 32.0),
				Rect2(32.0, 113.0, 16.0, 32.0), Rect2(48.0, 113.0, 16.0, 32.0),
				Rect2(64.0, 113.0, 16.0, 32.0), Rect2(80.0, 113.0, 16.0, 32.0),
				Rect2(96.0, 113.0, 16.0, 32.0), Rect2(112.0, 113.0, 16.0, 32.0)
			],
			"COLOR": Color(0.341, 0.464, 0.874)
		},
		"PURPLE_ICED": {
			"REGIONS_RECTS": [
				Rect2(0.0, 225.0, 16.0, 32.0), Rect2(16.0, 225.0, 16.0, 32.0),
				Rect2(32.0, 225.0, 16.0, 32.0), Rect2(48.0, 225.0, 16.0, 32.0),
				Rect2(64.0, 225.0, 16.0, 32.0), Rect2(80.0, 225.0, 16.0, 32.0),
				Rect2(96.0, 225.0, 16.0, 32.0), Rect2(112.0, 225.0, 16.0, 32.0)
			],
	...
	"MEDIUM_SMALL": {
		...
		"REGULAR_ICED": {
			"REGIONS_RECTS": [
				Rect2(0.0, 0.0, 33.0, 32.0), Rect2(32.0, 1.0, 32.0, 32.0),
				Rect2(64.0, 0.0, 33.0, 32.0), Rect2(96.0, 11.0, 32.0, 32.0)
			],
			"COLOR": Color(0.545, 0.713, 0.466)
		},
		"BLUE_ICED": {
			"REGIONS_RECTS": [
				Rect2(0.0, 113.0, 32.0, 32.0), Rect2(32.0, 113.0, 32.0, 32.0),
				Rect2(64.0, 113.0, 32.0, 32.0), Rect2(96.0, 113.0, 32.0, 32.0)
			],
			"COLOR": Color(0.341, 0.464, 0.874)
		},
		"PURPLE_ICED": {
			"REGIONS_RECTS": [
				Rect2(0.0, 224.0, 33.0, 32.0), Rect2(32.0, 225.0, 32.0, 32.0),
				Rect2(64.0, 224.0, 33.0, 32.0), Rect2(96.0, 225.0, 32.0, 32.0),
			],
			"COLOR": Color(0.482, 0.345, 0.662)
		}
	},
	"LARGE_SMALL": {
		...
		"REGULAR_ICED": {
			"REGIONS_RECTS": [Rect2(144.0, 1.0, 80.0, 32.0)],
			"COLOR": Color(0.545, 0.713, 0.466)
		},
		"BLUE_ICED": {
			"REGIONS_RECTS": [Rect2(144.0, 113.0, 80.0, 32.0)],
			"COLOR": Color(0.341, 0.464, 0.874)
		},
		"PURPLE_ICED": {
			"REGIONS_RECTS": [Rect2(144.0, 225.0, 80.0, 32.0)],
			"COLOR": Color(0.482, 0.345, 0.662)
		}
	},
	"MEDIUM": {
		...
		"REGULAR_ICED": {
			"REGIONS_RECTS": [
				Rect2(0.0, 65.0, 32.0, 48.0), Rect2(32.0, 65.0, 32.0, 48.0),
				Rect2(64.0, 65.0, 32.0, 48.0), Rect2(96.0, 65.0, 32.0, 48.0)
			],
			"COLOR": Color(0.545, 0.713, 0.466)
		},
		"BLUE_ICED": {
			"REGIONS_RECTS": [
				Rect2(0.0, 177.0, 32.0, 48.0), Rect2(32.0, 177.0, 32.0, 48.0),
				Rect2(64.0, 177.0, 32.0, 48.0), Rect2(96.0, 177.0, 32.0, 48.0)
				],
			"COLOR": Color(0.341, 0.464, 0.874)
		},
		"PURPLE_ICED": {
			"REGIONS_RECTS": [
				Rect2(0.0, 289.0, 32.0, 48.0), Rect2(32.0, 289.0, 32.0, 48.0),
				Rect2(64.0, 289.0, 32.0, 48.0), Rect2(96.0, 289.0, 32.0, 48.0)
			],
			"COLOR": Color(0.482, 0.345, 0.662)
		}
	},
	"LARGE": {
		...
		"REGULAR_ICED": {
			"REGIONS_RECTS": [
				Rect2(128.0, 49.0, 48.0, 64.0), Rect2(176.0, 49.0, 48.0, 64.0),
				Rect2(224.0, 49.0, 48.0, 64.0), Rect2(272.0, 49.0, 48.0, 64.0)
			],
			"COLOR": Color(0.545, 0.713, 0.466)
		},
		"BLUE_ICED": {
			"REGIONS_RECTS": [
				Rect2(128.0, 161.0, 48.0, 64.0), Rect2(176.0, 161.0, 48.0, 64.0),
				Rect2(224.0, 161.0, 48.0, 64.0), Rect2(272.0, 161.0, 48.0, 64.0)
			],
			"COLOR": Color(0.341, 0.464, 0.874)
		},
		"PURPLE_ICED": {
			"REGIONS_RECTS": [
				Rect2(128.0, 273.0, 48.0, 64.0), Rect2(176.0, 273.0, 48.0, 64.0),
				Rect2(224.0, 273.0, 48.0, 64.0), Rect2(272.0, 273.0, 48.0, 64.0)
			],
			"COLOR": Color(0.482, 0.345, 0.662)
		}
	}
